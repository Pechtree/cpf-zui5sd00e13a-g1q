...
sap.ui.define([
	...
	Group.prototype._renderHeader = function (mOptions) {
		...
		mOptions.renderManager.write(this._renderHtmlIcon(this.getCollapsed() ? EXPAND_ICON : COLLAPSE_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "collapse", "tabindex=\"0\"" + sContentStyle));
		mOptions.renderManager.write(this._renderHtmlIcon(MENU_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "menu", "tabindex=\"0\"" + sContentStyle));
		mOptions.renderManager.write("</div>");
