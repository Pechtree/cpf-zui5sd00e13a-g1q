sap.ui.define([
	 ...
	 * @public
	 */
	ColumnType.setColumnType = function(oColumn, sNewColumnType) {
		...
		switch (sNewColumnType) {
			...
			case COLUMNTYPE_CHART:
				...
				var oChart = DesigntimeUtils.createNewChart(sDataPointQualifier);
				...
				oCustomChange = AnnotationChangeUtils.createCustomAnnotationTermChange(sTarget, oDataPoint, {}, DATAPOINT + sDataPointQualifier);
				aCustomChanges.push(oCustomChange);
				sRecordType = DATAFIELDFORANNOTATION;
				break;
