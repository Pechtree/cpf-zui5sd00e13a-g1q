	...
	function(SmartForm, Group, ObjectPageLayout, ObjectPageSection, GroupElement, ObjectPageHeader, ObjectPageHeaderActionButton,
		...
		var getButtonDesigntime = function(oElement) {
			...
			if (oElement.getId().indexOf("::Determining") >= 0) {
				...
				var oDetermingButtonProperties = {
					//Virtual Properties:
					determiningActionType: {
						name: oResourceBundle.getText("FE_DETERMINING_ACTION_TYPE"),
							virtual: true,
							ignore: false,
							type: "EnumType",
				...
				jQuery.extend(true, oButtonData.properties, oDetermingButtonProperties);
			}
			return oButtonData;
		};
