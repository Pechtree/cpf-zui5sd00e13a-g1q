...
], function(jQuery, ControllerExtension, DateFormat, MessageBox, Filter, Sorter, SelectionVariant, testableHelper, detailUtils, SideContentHandler,
		...
		getMethods: function(oViewProxy, oTemplateUtils, oController) {
			...
			function onBreadCrumbUrlPressed(oEvent) {
				...
				oTemplateUtils.oCommonUtils.processDataLossConfirmationIfNonDraft(function() {
					...
					oTemplateUtils.oServices.oNavigationController.navigateToContext(oInfoObject.internalHash, null, false, iDisplayMode);
			...
			var oControllerImplementation = {
				...
				formatters: {
					...
					setNoDataTextForSmartTable: function() {
						var sText = oTemplateUtils.oCommonUtils.getText("NOITEMS_SMARTTABLE");
						if (sText !== "NOITEMS_SMARTTABLE") {
							return sText;
						}
