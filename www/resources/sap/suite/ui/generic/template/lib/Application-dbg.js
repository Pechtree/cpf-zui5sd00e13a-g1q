sap.ui.define(["jquery.sap.global", 
	...
	"sap/suite/ui/generic/template/lib/BeforeSaveHelper",
	...
	function(jQuery, BaseObject, Device, JSONModel, MessageToast, ActionSheet, Dialog, Popover, deletionHelper, 
		routingHelper, BeforeSaveHelper, ContextBookkeeping, StatePreserver, testableHelper, Log) {
		"use strict";
		...
		function getMethods(oTemplateContract) {
			...
			// Each Promise will be resolved to the corresponding entzry of aInfoObjects as soon as mAppStates and fullLink are available.
			...
			function getLinkToUpperLayersInfo(bIncludeRoot, bIncludeMe, sEntitySet){
				var aInfoObjects = [];
				var oCurrentNode = oTemplateContract.mEntityTree[sEntitySet];
