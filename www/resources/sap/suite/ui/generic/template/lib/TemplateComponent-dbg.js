sap.ui.define(["jquery.sap.global",
	...
	"sap/suite/ui/generic/template/js/AnnotationHelper"
], function(jQuery, CustomizingConfiguration, coreLibrary, Component, UIComponent, JSONModel, ResourceModel, Device,
		reuseComponentHelper, CustomData, StableIdDefinition, StableIdHelper, Log, AnnotationHelper) {
		"use strict";
		...
		function fnPlaceEmbeddedComponent(oComponentRegistryEntry, mReuseComponentProxies, sEmbeddedKey, oEmbeddedComponentMeta, oEmbeddedComponent){
			...
			var mSettings = oContainer.getSettings();
