...
sap.ui.define([
	...
	function getMethods(oAppComponent, oAppId) {
		...
		// - bCanonicalRequests flag determining whether the OData model has the canonicalRequests flag set. Added in init().
		...
		function init(){
			...
			oTemplateContract.bCanonicalRequests = false; // oModel.canonicalRequestsEnabled();
