            ...
            createInstance: function (oPublicServiceContext) {
                ...
                return new Promise(function (fnResolve, fnReject) {
                    ...
                    getService(sUshellServiceName).then(function (oUshellService) {
                        ...
                        if (oUshellService instanceof NavigationService || oUshellService instanceof DataService) {
                            // TODO: this is a quickfix. instead a real UI5 service should be implemented
                            // the ushell service already extends a UI5 API --> return the service directly
                            // note: allways the same instance is returned!
                            fnResolve(oUshellService);
                            return;
                        }
