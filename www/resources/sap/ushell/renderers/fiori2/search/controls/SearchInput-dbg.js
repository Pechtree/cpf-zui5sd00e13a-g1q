...
sap.ui.define([
    ...
    'sap/ui/base/Event'
], function (SearchHelper, SearchConfiguration, Input, SuggestionType, HorizontalLayout, VerticalLayout, Log, SearchObjectSuggestionImage, Event) {
    "use strict";
    ...
    sap.m.Input.extend('sap.ushell.renderers.fiori2.search.controls.SearchInput', {
        ...
        logRecentActivity: function (suggestion) {
            try {
                ...
                Log.warning('user recent activity logging failed:' + e);
            }
        },
