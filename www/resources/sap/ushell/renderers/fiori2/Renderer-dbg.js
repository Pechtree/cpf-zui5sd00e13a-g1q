...
sap.ui.define(
    [
        ...
        var bNoViewports = Config.last("/core/shell/enableFiori3") === true;
        ...
        var Renderer = UIComponent.extend("sap.ushell.renderers.fiori2.Renderer", {
            metadata : {
                ...
                routing: {
                    config: {
                        ...
                        controlAggregation: bNoViewports ? "pages" : "centerViewPort" // AppContainer and ViewPortContainer have different aggregation names for content
                    },
                    routes: [{
            ...
            init: function () {
                ...
                oRouter.getRoute("appfinder").attachMatched(function (oEvent) {
                    ...
                    // wait for the root view to be loaded before the inner hash
                    // is forwarded to the AppFinder component
    ...
    Renderer.prototype.createContent = function () {
        ...
        oView = sap.ui.view("mainShell", {
            ...
            //height: "100vh", // Removed temporary until vh units are allowed in 1.56, see also ShellLayout.less
            viewData: viewData
        });

        if (Config.last("/core/shell/enableFiori3") === true) {
            oView.addStyleClass("sapUshellFiori3");
        }
    ...
    Renderer.prototype.setFooterControl = function (controlType, oControlProperties) {
        ...
        } else if (!jQuery.sap.getObject(controlType)) {
...
/*------------Custom State Entry------------------------------*/
    ...
    Renderer.prototype.switchViewPortStateByControl = function (oOpenByControl, sState) {
        ...
        function fAfterAnimationFinishedCB () {
            ...
            // detach the callback
            that.shellCtrl.getViewPortContainer().detachAfterSwitchStateAnimationFinished(fAfterAnimationFinishedCB);
        }
        ...
        this.shellCtrl.getViewPortContainer().switchState(sState);
    };

    Renderer.prototype.ViewPortContainerAttachAfterSwitchStateAnimationFinished = function (func) {
        this.shellCtrl.getViewPortContainer().attachAfterSwitchStateAnimationFinished(func);
    };
