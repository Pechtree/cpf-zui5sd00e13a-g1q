 ...
 * @since 1.15.0
 */
sap.ui.define(['sap/ushell/User','sap/ushell/utils', "sap/ushell/Config"],
	function(User, utils, Config) {
	"use strict";
    ...
    var ContainerAdapter = function (oSystem, sParameter, oAdapterConfiguration) {
        ...
        oUserConfig = { // default values
            ...
            bootTheme: {
                theme: Config.last("/core/shell/enableFiori3") && "sap_fiori_3" || "sap_belize",
                root: ""
            },
