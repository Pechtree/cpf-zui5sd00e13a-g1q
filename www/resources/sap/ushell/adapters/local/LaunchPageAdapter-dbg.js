...
sap.ui.define([
...
], function (resources, ResourceModel, GenericTile, ImageContent, TileContent, NumericContent, mobileLibrary, ComponentContainer, OData) {
    "use strict";
    ...
    var LaunchPageAdapter = function (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this.getCardManifest = function (oGroupCard) {
            ...
            return new jQuery.Deferred().resolve(oManifestCopy).promise();
        };
        ...
        this.addBookmark = function (oParameters, oGroupParam) {
            var oGroup = oGroupParam ? oGroupParam : defaultGroup,
                oDfd = jQuery.Deferred(),
                bFail = getSimulateFail(),
                that = this,
