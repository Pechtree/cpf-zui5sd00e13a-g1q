...
sap.ui.define([
...
], function (Parameters, URI, fnClone, oType) {
    "use strict";
     ...
     *
     * Returns the default <code>oDefault</code> if specified, or <code>undefined</code>
     * if there is no such property in any object.
     *
     * @param  {object[]} aObjects an array of objects
     * @param  {string|array} oAccessPath one or more access paths to nested properties
     * as string or array.
     ...
     * @returns {any} the value of the desired property, or the default value
     * if the desired property is not defined in any object of <code>aObjects</code>.
     ...
     * supported by all browsers and evaluated by performance test tools
     *
     * @param {string} sMeasureMark the name of the performance measure
     ...
     * the private epcm object. This is expected to be a string in hex format
     * representing 4 bits, where the least significant bit represents native
     * navigation capability.
     *
     * For example: "B" = 1011, last bit is 1, therefore native navigation
     ...
     * NWBC exposes a feature bit vector via the getNwbcFeatureBits method of
     * the private epcm object. This is expected to be a string in hex format
     * representing 4 bits, where the second least significant bit represents
     * native logout capability.
     *
     * For example: "B" = 1011, second last bit is 1, therefore native logout
     * capability is enabled.
     *
     * @return {boolean}
     ...
     * NWBC exposes a feature bit vector via the getNwbcFeatureBits method of
     * the private epcm object. This is expected to be a string in hex format
     * representing 4 bits, where the second most significant bit represents
     * the capability to accept the navigation mode parameter.
     *
     * For example: "B" = 1011, the second most significant is 0, therefore
     * the capability to accept the navigation mode parameter is not enabled.
     *
     * @return {boolean}
    ...
    /**
     * Detect whether NWBC can be notifed that the Container and its services
     * are ready to be used
     *
     * NWBC exposes a feature bit vector via the getNwbcFeatureBits method of
     * the private epcm object. This is expected to be a string in hex format
     * representing 4 bits, where the most significant bit represents the flp
     * ready notification capability.
     *
     * For example: "B" = 1011, the most significant bit is 1, therefore the
     * flp ready notification capability is enabled.
     *
     * @return {boolean}
     *     whether NWBC can be notifed that the Container and its services
     *     are ready to be used
     */
     ...
     * which might to change
     * @param {Object} parameters
     *    The parameter object, e.g.
     *    <code>{ ABC : [1,"1 2"], DEF : ["4"]}</code>
     * @param {String} delimiter
     *    string to use as parameter delimiter, default is "&"
     * @param {String} assign
     *    string to use for parameter assignment, default is "="
     * @returns {String}
     *    The result parameter string, e.g.
     *    <code>ABC=1&ABC=1%202&DEF=4</code>
     *    The result is *not* prefixed with a "?".
     *    Parameter values are URI encoded.
     *
     * @since 1.63.0
     * @private
     */
