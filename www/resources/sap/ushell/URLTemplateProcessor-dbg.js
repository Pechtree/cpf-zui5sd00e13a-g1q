...
sap.ui.define([
    ...
    function expand (oTemplatePayload, oSite, oRuntime, oApplicationContext, sDefaultNamespace) {
        ...
        var oParameterSet = mergeObject(oRuntimeParamsSimpleSet, oDefinitionParamsSet);
        var oParameterSetParsed = oTemplateParameterParser.parseTemplateParameterSet(oParameterSet, sDefaultNamespace);
        ...
        var aPostExpansionOperations = extractPostExpansionOperations(oParameterSet || {});
