 ...
 */
    ...
    ViewPortContainer.prototype.init = function () {
        ...
        Device.orientation.attachHandler(function () {
            this.switchState("Center"); // Close MeArea and Notifications, otherwise the layout is broken
    ...
    ViewPortContainer.prototype.addCenterViewPort = function (oControl) {
        ...
        if (this.getDomRef() && !bIsInCenterViewPort) {
            this.getRenderer().renderViewPortPart(oControl, this.getDomRef(), 'centerViewPort');
        }
    ...
    ViewPortContainer.prototype.addLeftViewPort = function (oControl, bIsHidden) {
        ...
        if (this.getDomRef()) {
            this.getRenderer().renderViewPortPart(oControl, this.getDomRef(), 'leftViewPort');
        }
    ...
    ViewPortContainer.prototype.addRightViewPort = function (oControl, bIsHidden) {
        oControl.toggleStyleClass("hidden", bIsHidden === undefined? true: bIsHidden);
        if (this.getDomRef()) {
            this.getRenderer().renderViewPortPart(oControl, this.getDomRef(), 'rightViewPort');
        }
