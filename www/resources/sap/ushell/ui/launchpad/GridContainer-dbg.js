...
sap.ui.define([
    ...
    GridContainer.prototype.init = function () {
        this.setAggregation("_grid", new CSSGrid({
            customLayout: new GridResponsiveLayout({
                layoutS: new GridSettings({
                    gridTemplateColumns: "repeat(auto-fill, 4.375rem)",
                    gridAutoRows: "4.375rem",
                    gridAutoFlow: "Row",
                    gridRowGap: "0.5rem",
                    gridColumnGap: "0.5rem"
                }),
                layoutM: new GridSettings({
                    gridTemplateColumns: "repeat(auto-fill, 5.25rem)",
                    gridAutoRows: "5.25rem",
                    gridAutoFlow: "Row",
                    gridRowGap: "0.5rem",
                    gridColumnGap: "0.5rem"
                }),
    ...
    GridContainer.prototype._addItemLayoutData = function (oItem) {
        ...
        if (oItem instanceof Tile) {
            ...
            oLayoutData = {
                gridRow: "span " + sCardRow,
                gridColumn: "span " + sCardColumn
            };
        }

        oItemLayout = new GridItemLayoutData(oLayoutData);
