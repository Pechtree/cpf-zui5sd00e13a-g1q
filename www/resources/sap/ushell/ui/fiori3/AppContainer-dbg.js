...
sap.ui.define([
    ...
    ], function (jQuery, Control, AccessKeysHandler/*, AppContainerRenderer */) {
    "use strict";
 ...
 */
var AppContainer = Control.extend("sap.ushell.ui.fiori3.AppContainer", /** @lends sap.ushell.ui.fiori3.AppContainer.prototype */ { metadata : {
    ...
    aggregations : {
        pages : {type : "sap.ui.core.Control", multiple : true, singularName : "pages"}
    },
    events : {
        afterNavigate : {
            parameters : {
 ...
 */
    ...
    AppContainer.prototype.removeCenterViewPort = AppContainer.prototype.removePages;
    ...
    AppContainer.prototype.navTo = function (viewPortId, pageId) {
        ...
        var oHomeContainer = sap.ushell.Container.getRenderer("fiori2").byId("Shell-home-component-container"),
        ...
        if (viewPortId !== "centerViewPort") {
            jQuery.sap.log.error("Navigation to " + viewPortId + " is not allowed in Fiori3");
            return;
        }
        if (this.getPages().indexOf(oTargetPage) === -1) {
            jQuery.sap.log.error("AppContainer: invalid navigation target");
            return;
        }
