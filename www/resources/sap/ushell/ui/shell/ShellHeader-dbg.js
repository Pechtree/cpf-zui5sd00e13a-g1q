    ...
    resources
        ...
        var ShellHeader = Control.extend("sap.ushell.ui.shell.ShellHeader", {
            ...
            metadata: {
                properties: {
                    ...
                    showSeparators: {type : "boolean", group : "Appearance", defaultValue : false, deprecated: true}
                },
                aggregations: {
                    ...
                    user: {type: "sap.ushell.ui.shell.ShellHeadUserItem", multiple: false, deprecated: true}, /* deprecated, Fiori 1 */
        ...
        ShellHeader.prototype.createUIArea = function (sId) {
            var headerArea = document.getElementById('shell-hdrcntnt')
                            || document.getElementById('shell-hdr');
            if (headerArea) {
                return;
            }
