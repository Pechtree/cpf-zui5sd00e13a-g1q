...
sap.ui.define([
    ...
    'sap/ushell/services/AllMyApps'
        ...
        ShellAppTitle = Button.extend("sap.ushell.ui.shell.ShellAppTitle",
            {
                ...
                renderer: {
                    render:  function (oRm, oControl) {
                        ...
                        oRm.addClass("sapUshellAppTitle sapUshellAppTitleClickable");
        ...
        ShellAppTitle.prototype.init = function () {
            var bFiori3 = Config.last("/core/shell/enableFiori3") === true;
            ...
            this.oIcon = IconPool.createControlByURI(IconPool.getIconURI(bFiori3 ? "megamenu" : "slim-arrow-down"));
