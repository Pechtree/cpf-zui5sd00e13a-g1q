...
sap.ui.define([
...
], function (Controller, AccessibilityCustomData, ShellUIService, EventHub, CatalogsManager, HashChanger) {
    "use strict";
    ...
    return Controller.extend("sap.ushell.components.appfinder.AppFinder", {
        onInit: function () {
            ...
            // This router instance needs the ShellNavigationHashChanger instance in order to get the intent prefixed to
            // the new hash automatically.
            // This router doesn't need to be initialized because it doesn't react to any hashChanged event. The new
            // hash will be consumed when the router in Renderer.js component calls its parse method.
