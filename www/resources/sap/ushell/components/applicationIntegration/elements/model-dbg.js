...
], function (EventHub, Config, utils, HeaderManager, StateHelper) {
    "use strict";
    ...
    function ElementsModel () {
        ...
        this._addActionButton = function (sPropertyString, aId, bCurrentState, aStates) {
            function fnUpdate (modelPropertyString, aIds, oCurrentModel) {
                ...
                function sortForFiori2 (aActions) {
                ...
                function sortForFiori3 (aActions) {
                    var aActionButtons = [];
                    var aOrderedButtons = [ "recentActivitiesBtn",
                ...
                var aNewActionButtons = Config.last("/core/shell/enableFiori3") ?
                                        sortForFiori3(aFilteredActions) :
                                        sortForFiori2(aFilteredActions);
