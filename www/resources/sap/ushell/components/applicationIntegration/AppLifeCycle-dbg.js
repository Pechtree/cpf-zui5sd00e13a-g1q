...
], function (ElementsModel, Storage, ApplicationContainer, ShellUIService, Application, RelatedServices, RelatedShellElements, AppMeta, AppConfiguration, utils, resources, Device, Config, EventHub, AppIsolationService, ApplicationType) {
    "use strict";
...
//                RelatedServices.active(oStorageEntry.service);
//                AppMeta.active(oStorageEntry.meta);
            }
        };
        ...
        this.isAppOfTypeCached = function (appId, bIsAppOfTypeCachable) {
            ...
            if (jQuery.sap.getUriParameters().get("sap-keep-alive") == "true" && bIsAppOfTypeCachable) {
                return true;
            }
        ...
        this.init = function (inAppState, oInViewPortContainer, inSRootIntent, inDisableHomeAppCache, oShellUIServiceChange, nInitialCashSize, aActions) {
        ...
        this.postMessageToIframeApp = function (sServiceName, sInterface, oMessageBody, bWaitForResponse) {
            ...
            if (oContainer && Application.isAppTypeSupported(oContainer, sServiceName, sInterface)) {
                aContainers.push(
