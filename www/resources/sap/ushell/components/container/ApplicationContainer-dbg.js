...
sap.ui.define([
    ...
    function render (oRenderManager, oContainer, sApplicationType, sUrl, sAdditionalInformation) {
        ...
        if (jQuery.sap.getUriParameters().get("sap-isolation-enabled") === "true") {
            ...
            if (pos >= 0) {
                var newUrl = sUrl.substr(0, pos);
                sUrl = newUrl + "#" + window.hasher.getHash();
            } else {
    ...
    var ApplicationContainer = Control.extend(sCOMPONENT, {
        ...
        assignCommunicationHandlers: function (oInShellCommunicationHandlersObj) {
            oShellCommunicationHandlersObj = oInShellCommunicationHandlersObj;
        },
        ...
        init: function () {
            ...
            this.assignCommunicationHandlers(PostMessageAPI.getAPIs());
