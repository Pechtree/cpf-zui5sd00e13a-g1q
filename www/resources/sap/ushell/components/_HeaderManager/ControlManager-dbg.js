    ...
    function (
        ...
        function init (oConfig, oHeaderController, oShellModel) {
            ...
            if (Config.last("/core/shell/enableFiori3")) {
                aCreatedControls.push(_createMeAreaToggleButtonFiori3(oShellModel));
            } else {
                aCreatedControls.push(_createMeAreaToggleButton(oShellModel));
            }
        ...
        function _createMeAreaToggleButtonFiori3 (oShellModel) {
            var sId = "meAreaHeaderButton";

            var oMeAreaToggleButton = new ShellHeadItem({
                id: sId,
            ...
            oMeAreaToggleButton.addEventDelegate({
                onsapskipforward: function (oEvent) {
            ...
            oMeAreaToggleButton.setModel(oShellModel);
            return sId;
        }

        function _createMeAreaToggleButton (oShellModel) {
            // The press handler is added in the MeArea Component
            var sId = "meAreaHeaderButton";
            var oMeAreaToggleButton = new ShellHeadItem({
                id: sId,
                icon: "{/userImage/personPlaceHolder}",
            ...
            oMeAreaToggleButton.addStyleClass("sapUshellPlaceHolders");
            oMeAreaToggleButton.setModel(oShellModel);
            return sId;
        }
        ...
        function _createNotificationButton (oShellModel) {
            ...
            if (Config.last("/core/shell/enableFiori3") !== true) {
                oNotificationToggleButton.addStyleClass("sapUshellPlaceHolders");
            }
