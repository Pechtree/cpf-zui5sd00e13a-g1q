...
sap.ui.define([], function () {
    ...
    function fnAddHeaderItems ( aCurrentlyExistingItems, aIdsToAdd) {
        ...
        // Check if meAreaHeaderButton is part of aCurrentlyExistingItems or aIdsToAdd. If so, place it in the beginning.
        if ( aCurrentlyExistingItems.indexOf("meAreaHeaderButton") > -1 || aIdsToAdd.indexOf("meAreaHeaderButton") > -1) {
            aNewItems.push("meAreaHeaderButton");
        }
