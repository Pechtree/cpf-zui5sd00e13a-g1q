...
sap.ui.define([
...
], function (LoaderExtensions, AppCommunicationMgr, AppRuntimeService, URI, RendererExtensions, AppConfiguration, ShellUIService, UserStatus) {
    "use strict";
    ...
    function AppRuntime () {
        this.main = function() {
            ...
            this.tempFixForCFuntilTheySubmitAFix();
        ...
        this.tempFixForCFuntilTheySubmitAFix = function () {
            try {
                if (jQuery.sap.getUriParameters().get("sap-cf-fix-enabled") === "true") {
                    jQuery("body").empty();
                    jQuery("body").removeClass("sapUShellFullHeight");
                    jQuery('body').attr('id', 'content');
                }
            } catch (e) {
                jQuery.sap.log.error("tempFixForCFuntilTheySubmitAFix exception: " + e);
            }
        };
        ...
        this.getPageConfig = function () {
            ...
            return new Promise(function (fnResolve) {
                LoaderExtensions.loadResource(DEFAULT_CONFIG_PATH, {async: true}).then(function (defaultShellConfig) {
                    metaData = jQuery.find("meta[name='sap.ushellConfig.ui5appruntime']")[0];
                    shellConfig = JSON.parse(metaData.content);
                    window['sap-ushell-config'] = jQuery.extend(true, {}, shellConfig, defaultShellConfig);
                    fnResolve();
                });
            });
        ...
        this.initServicesContainer = function () {
            return new Promise(function (fnResolve, fnReject) {
                sap.ui.require(["sap/ushell/appRuntime/ui5/services/Container"], function (oContainer) {
                    oContainer.bootstrap("local").then(function () {
                        fnResolve();
                    });
                });
            });
        ...
        this.getAppId = function () {
            var sAppId = oPageUriParams["sap-ui-app-id"];
        ...
        this.setApplicationParameters = function (oAppInfo) {
            ...
            /* In between the calls to the inner functions 'setPerliminaryParams()' and 'setLateParams()', the case of
            ...
            */
            ...
            function setPerliminaryParams(sTempHash) {
