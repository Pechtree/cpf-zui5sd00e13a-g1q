sap.ui.define([
...
],function (CrossApplicationNavigation, AppRuntimeService, AppStateAppState) {
    "use strict";
    ...
    function CrossApplicationNavigationProxy (oContainerInterface, sParameters, oServiceConf) {
        ...
        //For a given semantic object, this method considers all actions associated with the semantic object and returns the one tagged as a "primaryAction"
        this.getPrimaryIntent = function (sSemanticObject, mParameters) {
            return AppRuntimeService.sendMessageToOuterShell(
