...
sap.ui.define([
...
], function (ShellNavigationHashChanger, oNavigationHistoryMonitor) {
    "use strict";
     ...
     *
     * @returns {object}
     *   The Navigation History Monitor interface, an object representing the
     *   navigation history monitor.
     *
     * @see sap.ushell.services.ShellNavigation._ShellNavigation.NavigationHistoryMonitor
     *
     * @protected
     */
    ShellNavigation.createNavigationHistoryMonitor = oNavigationHistoryMonitor.create.bind(
        null,
        {} /* oEnv */,
        ShellNavigation.EVENTS
    );
