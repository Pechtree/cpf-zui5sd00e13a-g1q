...
/*global sap*/
sap.ui.define([
    "sap/ushell/services/_CardUserRecents/CardUserRecentsBase",
    "sap/ushell/EventHub",
    "sap/ushell/Config"
     ...
     * @since 1.64
     */
    var CardUserFrequents = CardUserRecentsBase.extend(function () {
        CardUserRecentsBase.call(this, "CardUserFrequents");
    });

    CardUserFrequents.prototype = CardUserRecentsBase.prototype;
