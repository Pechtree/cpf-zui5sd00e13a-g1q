...
sap.ui.define([
    ...
    "sap/ushell/Config"
], function (OData, SapPcpWebSocket, Config) {
    "use strict";
    ...
    function Notifications (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.init = function () {
            if ((!bInitialized) && (this.isEnabled())) {
                ...
                bPreviewNotificationEnabled = oServiceConfig.enableNotificationsPreview;
        ...
        /**
         * Returns a dissmissed notifications
         *
         * @since 1.43
         *
         * @private
        ...
        /**
         * Indicating whether the notification preview setting is visible
         * depends on Fiori 3
         *
         * @private
         *
         * @returns {boolean} returns true if notification preview setting is visible
         */
        this._getNotificationSettingsPreviewVisible = function () {
            return Config.last("/core/shell/enableFiori3") !== true;
        };
