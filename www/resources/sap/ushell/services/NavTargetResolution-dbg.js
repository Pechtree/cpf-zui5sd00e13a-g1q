...
sap.ui.define([
    ...
    function NavTargetResolution(oAdapter, oContainerInterface, sParameters, oServiceConfiguration) {
         ...
         *
         * This function should be used by the NWBC browser in order to
         * get a resolved target corresponding to a certain configuration object describing the target.
         * Do not use this function for developing Fiori applications.
         *
         * @param {object} oArgs
         *   <code> { target : {
         *                       semanticObject : "semantic object",<br/>
         *                       action : "action",<br/>
         *                     },<br/>
         *            params :  {
         *                  "sap-system-src": "e.g. sid(UR5.120)",<br/>
         *                  "sap-system": {<br/>
         *                           ... data related to the sap-system<br/>
         *                     }<br/>
         *            }
         *          }<br/>
         *    </code>
         ...
         *     A jQuery.Promise. Its <code>done()</code> function gets an object
         *
        ...
        this.resolveTarget = function (oArgs) {
            ...
            jQuery.sap.measure.average("sap.ushell.navigation.resolveTarget");
            ...
            sap.ushell.Container.getService("NavTargetResolution").resolveHashFragment("#" + sHashFragment).done(function(oResolved) {
                jQuery.sap.measure.end("sap.ushell.navigation.resolveTarget");
                oDeferred.resolve({
                    url: oResolved.url,
                    text: oResolved.text,
