...
sap.ui.define([
     ...
     * @since 1.64
     */
    var CardUserRecents = CardUserRecentsBase.extend(function () {
        CardUserRecentsBase.call(this, "CardUserRecents");
    });

    CardUserRecents.prototype = CardUserRecentsBase.prototype;
