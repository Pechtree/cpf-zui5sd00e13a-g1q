...
sap.ui.define([
     ...
     *
     * When using the content extension factory, any extended content needs to refer to the correct
     * adapter with the field "contentProvider".
     *
    ...
    function LaunchPage (oAdapter, oContainerInterface) {
        ...
        this.isLinkPersonalizationSupported = function (oTile) {
            ...
            var oAdapter = this._getAdapter(sAdapterName);
        ...
        this.getTileView = function (oTile) {
            var sAdapterName = oTile && oTile.contentProvider;
            var oDfd = this._getAdapter(sAdapterName).getTileView(oTile);
            /**
