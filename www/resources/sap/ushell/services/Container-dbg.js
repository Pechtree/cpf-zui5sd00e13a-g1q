...
sap.ui.define([
     ...
     * @param {boolean} bAddCallProtection Whether to add call protection check. This may not be wanted in case
     *  the service is created via: ServiceFactoryRegistry#get("sap.ushell.ui5service.<service>").createInstance().
     *
     * @private
     */
