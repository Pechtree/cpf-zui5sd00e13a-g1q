...
sap.ui.define([
	...
	SmartTable.prototype._createResponsivePopover = function() {
		...
		var oToolbar = new OverflowToolbar({
			content: [
				this._oSortButton, this._oFilterButton, new ToolbarSpacer(), new OverflowToolbarButton({
					type: "Transparent",
