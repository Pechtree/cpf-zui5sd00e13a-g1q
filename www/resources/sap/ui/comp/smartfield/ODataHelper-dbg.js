...
sap.ui.define([
	...
	ODataHelper.prototype.getTextAnnotationPropertyPath = function(oMetaData) {
		var oTextAnnotation = oMetaData.annotations.text;
	...
	ODataHelper.prototype.getAbsolutePropertyPathToValueListEntity = function(oSettings) {
		var oValueListKeyProperty = oSettings.property,
			...
			oValueListEntitySet = oSettings.entitySet,
			vValue;

		if (oValueListTextAnnotation && oValueListEntitySet && (oSettings.entityID !== undefined)) {
